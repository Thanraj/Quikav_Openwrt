...
pkgdatadir = $(datadir)/quikav
pkgincludedir = $(includedir)/quikav
pkglibdir = $(libdir)/quikav
pkglibexecdir = $(libexecdir)/quikav
...
#am__append_1 = quiksubmit
#am__append_2 = libfreshquik
subdir = .
DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/Makefile.am \
	$(top_srcdir)/configure $(am__configure_deps) \
	$(srcdir)/quikav-config.h.in $(srcdir)/quikav-config.in \
	$(srcdir)/libquikav.pc.in $(srcdir)/platform.h.in \
	$(top_srcdir)/docs/man/quikav-milter.8.in \
	$(top_srcdir)/docs/man/quikav-milter.conf.5.in \
	$(top_srcdir)/docs/man/quikbc.1.in \
	$(top_srcdir)/docs/man/quikconf.1.in \
	$(top_srcdir)/docs/man/quikd.8.in \
	$(top_srcdir)/docs/man/quikd.conf.5.in \
	$(top_srcdir)/docs/man/quikdscan.1.in \
	$(top_srcdir)/docs/man/quikscan.1.in \
	$(top_srcdir)/docs/man/freshquik.1.in \
	$(top_srcdir)/docs/man/freshquik.conf.5.in \
	$(top_srcdir)/docs/man/sigtool.1.in \
	$(top_srcdir)/docs/man/quikdtop.1.in \
	$(top_srcdir)/docs/man/quiksubmit.1.in AUTHORS COPYING \
...
am__aclocal_m4_deps = $(top_srcdir)/m4/acinclude.m4 \
	...
	$(top_srcdir)/m4/reorganization/quikav_user.m4 \
	...
	$(top_srcdir)/m4/reorganization/quikdtop.m4 \
	...
	$(top_srcdir)/m4/reorganization/libfreshquik.m4 \
...
CONFIG_HEADER = quikav-config.h
CONFIG_CLEAN_FILES = quikav-config libquikav.pc platform.h \
	docs/man/quikav-milter.8 docs/man/quikav-milter.conf.5 \
	docs/man/quikbc.1 docs/man/quikconf.1 docs/man/quikd.8 \
	docs/man/quikd.conf.5 docs/man/quikdscan.1 docs/man/quikscan.1 \
	docs/man/freshquik.1 docs/man/freshquik.conf.5 \
	docs/man/sigtool.1 docs/man/quikdtop.1 docs/man/quiksubmit.1
...
CTAGS = ctags
CSCOPE = cscope
DIST_SUBDIRS = libltdl libquikav quikscan quikd quikdscan freshquik \
	sigtool quikconf database docs etc quikav-milter test quikdtop \
	quikbc unit_tests quiksubmit libfreshquik
...
ACLOCAL = ${SHELL} /Thanaraj/MyOpenWrt/quikav-0.99.2/config/missing aclocal-1.14
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
AUTOCONF = ${SHELL} /Thanaraj/MyOpenWrt/quikav-0.99.2/config/missing autoconf
AUTOHEADER = ${SHELL} /Thanaraj/MyOpenWrt/quikav-0.99.2/config/missing autoheader
AUTOMAKE = ${SHELL} /Thanaraj/MyOpenWrt/quikav-0.99.2/config/missing automake-1.14
AWK = gawk
...
FGREP = /bin/grep -F
FRESHQUIK_CPPFLAGS = 
FRESHQUIK_LIBS =  -lz -lresolv
GCOV = 
GENHTML = 
GETENT = 
GPERF = ${SHELL} /Thanaraj/MyOpenWrt/quikav-0.99.2/config/missing gperf
GREP = /bin/grep
HAVE_YARA = 
INCLTDL = 
...
LIBQUIKAV_CPPFLAGS = 
LIBQUIKAV_LIBS =  -lz
LIBQUIKAV_VERSION = 8:1:1
LIBQUIKSHARED_CPPFLAGS = 
LIBLTDL = -lltdl
LIBM = -lm
LIBOBJS = 
LIBS = 
...
LTLIBOBJS = 
LT_ARGZ_H = 
LT_CONFIG_H = quikav-config.h
LT_DLLOADERS =  dlopen.la
LT_DLPREOPEN = -dlpreopen dlopen.la 
LT_SYS_LIBRARY_PATH = 
MAINT = #
MAKEINFO = ${SHELL} /Thanaraj/MyOpenWrt/quikav-0.99.2/config/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
OTOOL64 = 
PACKAGE = quikav
PACKAGE_BUGREPORT = http://bugs.quikav.net/
PACKAGE_NAME = QuikAV
PACKAGE_STRING = QuikAV 0.99.2
PACKAGE_TARNAME = quikav
PACKAGE_URL = http://www.quikav.net/
...
YACC = yacc
YFLAGS = 
abs_builddir = /Thanaraj/MyOpenWrt/quikav-0.99.2
abs_srcdir = /Thanaraj/MyOpenWrt/quikav-0.99.2
abs_top_builddir = /Thanaraj/MyOpenWrt/quikav-0.99.2
abs_top_srcdir = /Thanaraj/MyOpenWrt/quikav-0.99.2
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /Thanaraj/MyOpenWrt/quikav-0.99.2/config/install-sh
...
SUBDIRS = libltdl libquikav quikscan quikd quikdscan freshquik sigtool \
	quikconf database docs etc quikav-milter test quikdtop quikbc \
...
distuninstallcheck_listfiles = find . -type f ! -name quikd.conf ! -name freshquik.conf ! -name daily.cvd ! -name main.cvd -print
...
quikav-config.h: stamp-h1
	@test -f $@ || rm -f stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) stamp-h1

stamp-h1: $(srcdir)/quikav-config.h.in $(top_builddir)/config.status
	@rm -f stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status quikav-config.h
$(srcdir)/quikav-config.h.in: # $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f stamp-h1
	touch $@

distclean-hdr:
	-rm -f quikav-config.h stamp-h1
quikav-config: $(top_builddir)/config.status $(srcdir)/quikav-config.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
libquikav.pc: $(top_builddir)/config.status $(srcdir)/libquikav.pc.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
platform.h: $(top_builddir)/config.status $(srcdir)/platform.h.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
docs/man/quikav-milter.8: $(top_builddir)/config.status $(top_srcdir)/docs/man/quikav-milter.8.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
docs/man/quikav-milter.conf.5: $(top_builddir)/config.status $(top_srcdir)/docs/man/quikav-milter.conf.5.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
docs/man/quikbc.1: $(top_builddir)/config.status $(top_srcdir)/docs/man/quikbc.1.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
docs/man/quikconf.1: $(top_builddir)/config.status $(top_srcdir)/docs/man/quikconf.1.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
docs/man/quikd.8: $(top_builddir)/config.status $(top_srcdir)/docs/man/quikd.8.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
docs/man/quikd.conf.5: $(top_builddir)/config.status $(top_srcdir)/docs/man/quikd.conf.5.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
docs/man/quikdscan.1: $(top_builddir)/config.status $(top_srcdir)/docs/man/quikdscan.1.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
docs/man/quikscan.1: $(top_builddir)/config.status $(top_srcdir)/docs/man/quikscan.1.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
docs/man/freshquik.1: $(top_builddir)/config.status $(top_srcdir)/docs/man/freshquik.1.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
docs/man/freshquik.conf.5: $(top_builddir)/config.status $(top_srcdir)/docs/man/freshquik.conf.5.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
docs/man/sigtool.1: $(top_builddir)/config.status $(top_srcdir)/docs/man/sigtool.1.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
docs/man/quikdtop.1: $(top_builddir)/config.status $(top_srcdir)/docs/man/quikdtop.1.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
docs/man/quiksubmit.1: $(top_builddir)/config.status $(top_srcdir)/docs/man/quiksubmit.1.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
...
all-am: Makefile $(SCRIPTS) $(DATA) quikav-config.h
