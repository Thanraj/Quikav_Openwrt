...
/* Oct 1, 2013
 * Adding quikav-config.h include here for size-checking on fall-through case
 */
#if HAVE_CONFIG_H
...
/* quikp digits */
#define fp_quikp(a)   { while ((a)->used && (a)->dp[(a)->used-1] == 0) --((a)->used); (a)->sign = (a)->used ? (a)->sign : FP_ZPOS; }

/* negate and absolute */
#define fp_neg(a, b)  { fp_copy(a, b); (b)->sign ^= 1; fp_quikp(b); }
