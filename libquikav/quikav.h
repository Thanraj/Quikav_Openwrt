...
typedef enum {
    ...
    /* internal (not reported outside libquikav) */
    CL_BREAK,
    CL_EMAXREC,
    CL_EMAXSIZE,
    CL_EMAXFILES,
...
enum cl_msg {
    ...
    CL_MSG_WARN = 64, /* LibQuikAV WARNING: */
    CL_MSG_ERROR = 128/* LibQuikAV ERROR: */
};
