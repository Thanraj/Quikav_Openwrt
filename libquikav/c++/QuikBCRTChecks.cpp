/*
 *  Compile LLVM bytecode to QuikAV bytecode.
 *
 ...
 *  MA 02110-1301, USA.
 */
#define DEBUG_TYPE "quikbc-rtcheck"
#include "QuikBCModule.h"
#include "QuikBCDiagnostics.h"
#include "llvm30_compat.h" /* libquikav-specific */
      ...
      virtual bool runOnFunction(Function &F) {
          ...
          */
          ...
          for (inst_iterator I=inst_begin(F),E=inst_end(F); I != E;++I) {
              Instruction *II = &*I;
              /* only appears in the libquikav version */
          ...
          if (!valid) {
              DEBUG(F.dump());
              QuikBCModule::stop("Verification found errors!", &F);
...
INITIALIZE_PASS_END(PtrVerifier, "quikbc-rtchecks", "QuikBC RTchecks", false, false)
#endif
