/*
 * Main YARA header file for QuikAV
 * 
...
#ifndef _YARA_QUIK_H_
#define _YARA_QUIK_H_
...
/* YARA to QuikAV function mappings */
...
/* YARA-defined structure replacements for QuikAV */
struct _yc_rule {
