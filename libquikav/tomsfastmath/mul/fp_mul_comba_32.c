...
void fp_mul_comba32(fp_int *A, fp_int *B, fp_int *C)
{
   ...
   if (out_size <= 40) { COMBA_STORE2(C->dp[39]); C->used = 40; C->sign = A->sign ^ B->sign; fp_quikp(C); COMBA_FINI; return; }
   ...
   if (out_size <= 48) { COMBA_STORE2(C->dp[47]); C->used = 48; C->sign = A->sign ^ B->sign; fp_quikp(C); COMBA_FINI; return; }
   ...
   if (out_size <= 56) { COMBA_STORE2(C->dp[55]); C->used = 56; C->sign = A->sign ^ B->sign; fp_quikp(C); COMBA_FINI; return; }
