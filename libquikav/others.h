...
#include "filetypes.h"
#include "fmap.h"
#include "libquikunrar_iface/unrar_iface.h"
...
#if HAVE_LIBXML2
#define QUIKAV_MIN_XMLREADER_FLAGS (XML_PARSE_NOERROR | XML_PARSE_NONET)
#endif
 ...
 * in the old versions of QuikAV. Updating CL_FLEVEL_DCONF will result
...
typedef struct cli_quikav_intel {
    char *hostid;
    char *host_info;
