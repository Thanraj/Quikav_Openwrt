...
#define unrar_open libquikunrar_iface_LTX_unrar_open
#define unrar_extract_next_prepare libquikunrar_iface_LTX_unrar_extract_next_prepare
#define unrar_extract_next libquikunrar_iface_LTX_unrar_extract_next
#define unrar_close libquikunrar_iface_LTX_unrar_close
