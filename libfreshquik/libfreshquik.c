...
#include "target.h"
#include "quikav.h"
#include "freshquik/freshquikcodes.h"
...
#include "freshquik/execute.h"
#include "freshquik/manager.h"
#include "freshquik/mirman.h"
#include "libfreshquik.h"
int sigchld_wait = 1;
        ...
        while (opt)
        {
                ...
                || ret == FCE_FAILEDGET || ret == FCE_MIRRORNOTSYNC)
            {
                ...
                else
                {
                    ...
                    if (!opt)
                    {
                        logg ("Update failed. Your network may be down or none of the mirrors listed in %s is working. Check http://www.quikav.net/support/mirror-problem for possible reasons.\n", cfgfile);
                    }
                }
