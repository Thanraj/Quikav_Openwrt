 ...
 *  Copyright (C) 2007-2012 Tringapps, Inc.
 *
 *  Authors: Tomasz Kojm
 *
...
int main(int argc, char **argv)
{
    ...
    if((opts = optparse(NULL, argc, argv, 1, OPT_QUIKSCAN, 0, NULL)) == NULL) {
...
void help(void)
{
    ...
    mprintf("    --debug                              Enable libquikav's debug messages\n");
    ...
    mprintf("    --scan-archive[=yes(*)/no]           Scan archive files (supported by libquikav)\n");
