/* quikav-config.h.  Generated from quikav-config.h.in by update-win32.  */

/* quikav-config.h.in.  Generated from configure.in by autoheader.  */
...
/* "build quikd" */
#define BUILD_QUIKD 1

/* name of the quikav group */
#define QUIKAVGROUP "quikav"

/* name of the quikav user */
#define QUIKAVUSER "quikav"
...
/* #undef FRESHQUIK_DNS_FIX */

/* use "Cache-Control: no-cache" in freshquik */
/* #undef FRESHQUIK_NO_CACHE */
...
#define LIBQUIKAV_FULLVER "6.0.4"

/* "Major library version number" */
#define LIBQUIKAV_MAJORVER 6
...
#define PACKAGE_BUGREPORT "http://bugs.quikav.net/"

/* Define to the full name of this package. */
#define PACKAGE_NAME "QuikAV"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "QuikAV devel"
...
#define VERSION "devel-quikav-0.97-408-ge11f7cc"
