...
#undef DATADIR
#undef CONFDIR
#if !defined(THIS_IS_LIBQUIKAV) && defined(_MSC_VER)
#define LIBQUIKAV_EXPORT __declspec(dllimport)
#else
#define LIBQUIKAV_EXPORT
#endif
LIBQUIKAV_EXPORT extern const char *DATADIR;
LIBQUIKAV_EXPORT extern const char *CONFDIR;
LIBQUIKAV_EXPORT extern const char *CONFDIR_QUIKD;
LIBQUIKAV_EXPORT extern const char *CONFDIR_FRESHQUIK;
LIBQUIKAV_EXPORT extern const char *CONFDIR_MILTER;
#undef HAVE_CONFIG_H
